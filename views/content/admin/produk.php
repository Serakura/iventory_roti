<div class="container-fluid p-1">
    <button type="button" class="btn btn-success mb-2" data-toggle="modal" style="float:right;" data-target="#tambahdataproduk" data-whatever="produk">Tambah Data Produk</button>
</div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a data-toggle="modal" data-target="#updatedataproduk<?php echo $d['id_produk']; ?>" class="link"><img name="pencil" src="../assets/edit.png"></a>
                        <a href="./content/function/hapusproduk.php?id_produk=<?php echo $d['id_produk'] ?>" class="link"><img name="delete" src="../assets/delete.png" onclick="return confirm('Yakin Akan di Hapus ?')"></a>
                    </td>
                </tr>
                <!-- Update Data Guru -->
