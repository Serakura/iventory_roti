<div class="container-fluid p-1">
    <button type="button" class="btn btn-success mb-2" data-toggle="modal" style="float:right;" data-target="#tambahdataproduksi" data-whatever="suplai">Tambah Data Produksi</button>
</div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="./content/function/hapusproduksi.php?id_produksi=<?php echo $d['id_produksi'] ?>&id_produk=<?php echo $d['id_produk'] ?>&jumlah=<?php echo $d['jumlah_produksi'] ?>" class="link"><img name="delete" src="../assets/delete.png" onclick="return confirm('Yakin Akan di Hapus ?')"></a>
                    </td>
                </tr>
