<div class="container-fluid p-1">
    <button type="button" class="btn btn-success mb-2" data-toggle="modal" style="float:right;" data-target="#tambahdatabahan" data-whatever="bahan">Tambah Data Bahan</button>
</div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a data-toggle="modal" data-target="#updatedatabahan<?php echo $d['id_bahan']; ?>" class="link"><img name="pencil" src="../assets/edit.png"></a>
                        <a href="./content/function/hapusbahan.php?id_bahan=<?php echo $d['id_bahan'] ?>" class="link"><img name="delete" src="../assets/delete.png" onclick="return confirm('Yakin Akan di Hapus ?')"></a>
                    </td>
                </tr>
                <!-- Update Data Guru -->
